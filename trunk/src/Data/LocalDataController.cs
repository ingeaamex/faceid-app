...
namespace FaceIDAppVBEta.Data
{
    public class LocalDataController : IDataController
    {
        ...
        {
            System.Data.OleDb.OleDbCommand odCom = BuildSelectCmd("FaceData", "*", null);
            System.Data.OleDb.OleDbDataReader odRdr = odCom.ExecuteReader();
        ...
        public FaceData GetFaceData(int id)
        {
            System.Data.OleDb.OleDbCommand odCom = BuildSelectCmd("FaceData", "*", "ID=@ID", new object[] { "@ID", id });
            System.Data.OleDb.OleDbDataReader odRdr = odCom.ExecuteReader();
        ...
        public int AddFaceData(FaceData _faceData)
        {
            System.Data.OleDb.OleDbCommand odCom1 = BuildInsertCmd("FaceData",
                new string[] { "PayrollNumber"
                ,"Data"
                },
                new object[] { _faceData.PayrollNumber
                ,_faceData.Data
                }
            );
        ...
        public bool UpdateFaceData(FaceData _faceData)
        {
            System.Data.OleDb.OleDbCommand odCom1 = BuildUpdateCmd("FaceData",
                new string[] { "PayrollNumber"
                ,"Data"
                },
                new object[] { _faceData.PayrollNumber
                ...
                "ID=@ID", new object[] { "@ID", _faceData.ID }
            );

            return odCom1.ExecuteNonQuery() > 0 ? true : false;
        }

        public bool DeleteFaceData(int id)
        {
